    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form id="demo-form2" action="/admin/user/add" method= "POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
             @if(count($errors) > 0)
            ...
            <input type="hidden" name="_token" value="{!! csrf_token() !!}">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input id="email" class="date-picker form-control col-md-7 col-xs-12"  name="email" type="email">
                </div>
              </div>
              <div class="form-group">
